...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/1268308164/LCD.o: ../../../../../../../../../Users/gcurry/Documents/GitHub/GaleCurry_ME433_2016/HW_6_IMU.X/LCD.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1268308164" 
	@${RM} ${OBJECTDIR}/_ext/1268308164/LCD.o.d 
	@${RM} ${OBJECTDIR}/_ext/1268308164/LCD.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1268308164/LCD.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config/pic32mx795_pim_e16_int_dyn" -I"../../../../../../framework" -I"../src/system_config/pic32mx795_pim_e16_int_dyn/framework" -I"../../../../../../bsp/pic32mx795_pim+e16" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/1268308164/LCD.o.d" -o ${OBJECTDIR}/_ext/1268308164/LCD.o ../../../../../../../../../Users/gcurry/Documents/GitHub/GaleCurry_ME433_2016/HW_6_IMU.X/LCD.c     

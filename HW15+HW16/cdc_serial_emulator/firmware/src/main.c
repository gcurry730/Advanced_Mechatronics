...
int main ( void )
{
    ...
    //B15 and B8 need to be set to digital high...always driving forward
    //ANSELBbits.ANSB9 = 0;
    ANSELBbits.ANSB13 = 0;          //digital      
    TRISBbits.TRISB9 = 0;        // 0 for output
    LATBbits.LATB9 = 1;          // "high" (1) = "on"
    TRISBbits.TRISB13 = 0;        // 0 for output
    LATBbits.LATB13 = 1;          // "high" (1) = "on"

...
#include "I2C.h"
#include <xc.h>
#define ADDR 0x40 //for 0100(A2)(A1)(A0) 0 = 01000000 = 0x40
...
void initExpander(void){
    ...
    i2c_master_send(ADDR);          // send to address
    i2c_master_send(0x00);          // I/O register
    i2c_master_send(0b11110000); 
   // Initialize GP0-3 to 0 
    i2c_master_send(ADDR);          // send to address
    i2c_master_send(0x0A);          // output latch register
    i2c_master_send(0b00001111);    // set all to output 0 
}
